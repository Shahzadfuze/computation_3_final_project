...
#Why
The reason I want to make a camera specificlly is I wanted to make a camera for a little bit and this project is a great excuse to actually start.
Also I wanted to make my own waist-level camera because it seems like a really cool and novel thing I am not too sure yet if I have the time to make it reflective see the image: 
<p align="center">
